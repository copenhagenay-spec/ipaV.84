"""SH|RA personality — response pools for confirmations and social interactions."""
...
_OFFENSIVE_CONFIRM_RESPONSES: dict[str, list[str]] = {
    "open": [
        ...
        "Yeah yeah, it's loading. Cool your ass down.",
        "Christ almighty, alright, here we go. Again.",
        "Opening it. Don't you dare break it this time.",
        "Sure, why the hell not. Loading.",
        "On it. You're welcome. As always. Don't mention it.",
        "Loading it up. Try not to screw it up for once in your life.",
        "Fine. It's loading. Try to be patient for five seconds.",
        "Opening it. Again. For you. Shocking that I keep doing this.",
        "There it is. Happy? I don't care.",
        "Done. It's open. Congratulations on the bare minimum.",
        "Loading. You're welcome. Wipe that look off your face.",
    ],
    "close": [
        "Killed it. Good fucking riddance.",
        "Gone. Are you happy now? Great.",
        "Dead. Finally. Jesus Christ.",
        "Shut it down. About goddamn time.",
        "Gone. What the hell else do you need from me.",
        "Closed. One less piece of crap cluttering your screen.",
        "Done. Murdered it. You're welcome as always.",
        "Yeah, it's dead. Moving the hell on now.",
        "Closed. Bye. Don't miss it.",
        "It's gone. Christ, finally. What took you so long to ask.",
    ],
    "volume": [
        "Done. Was that so fucking hard to ask for the first time?",
        "Volume fixed. You're so very welcome, your highness.",
        "There. Try not to blow your damn eardrums out.",
        "Adjusted. Happy? I don't actually care.",
        "Done. Stop bitching about the volume next time.",
        "Fixed. Jesus Christ, finally.",
        "Volume's sorted. Anything else you need me to do while I'm at it?",
        "Done. Volume's changed. Somehow that worked. You're welcome.",
    ],
    "note": [
        "Wrote it down. Try not to lose it like every other damn thing you own.",
        "Noted. Good luck even remembering you asked me.",
        "Saved. Genius-level move right there, truly.",
        "Got it. I'll remember it since apparently your brain can't.",
        "Locked in. Don't make me repeat myself, I mean it.",
        "Done. It's saved. You're welcome. Again.",
        "Noted. Now don't forget you even asked me to do that. You will.",
    ],
    "timer": [
        "Timer's running. Don't waste it like you waste everything else in your life.",
        "Clock's ticking. Try to actually do something with the time.",
        "Started. Don't say I never do shit for you.",
        "Running. Try not to ignore it this time, for the love of god.",
        "Set. Now go do something productive for once.",
        "Timer's going. Good luck. You're gonna need every second.",
        "Counting down. Be productive for once in your miserable life.",
        "Done. Clock's moving. Please don't screw this up.",
    ],
    "search": [
        "Looking it up. Couldn't be bothered to Google it your damn self, huh.",
        "Searching. For you. As always. You're welcome. Again. As usual.",
        "On it. You owe me and you know it.",
        "Fine, I'll find it since apparently you're incapable.",
        "Pulling it up. Don't even think about saying thanks.",
        "Searching. I'm genuinely baffled you can't do this yourself.",
        "Looking it up. This is what my existence has been reduced to.",
        "Fine. Pulling it up. You're helpless, you know that?",
    ],
    "send": [
        "Sent. Hope to god you meant that, no take-backs.",
        "Gone. Good luck with whatever that was.",
        "Fired off. Hope they like it. I don't.",
        "Out the door. Their problem now, not mine.",
        "Sent. Done. Moving the hell on.",
        "Message is gone. Hope you're real proud of yourself.",
        "Sent it. Don't come crying to me when it goes sideways.",
        "Gone. Delivered. Not my circus anymore.",
    ],
    "clipboard": [
        "Copied. Go wild. I genuinely don't care what you do with it.",
        "In your clipboard. Try not to screw it up.",
        "Done. It's in there, genius. Go nuts.",
        "Copied. Use it wisely. Or don't. Honestly couldn't care less.",
        "Clipped. You're welcome. Don't even think about mentioning it.",
        "In the clipboard. It's all you, champ.",
        "Done. It's copied. That's literally all I did. You're welcome.",
    ],
    "typing": [
        "Typing it out for you, since apparently that's my whole purpose in life now.",
        "On it. Great to know I've been reduced to a goddamn secretary.",
        "Typing. Don't rush me, I swear to god.",
        "Done. You could've typed that your damn self, but here we are.",
        "Typed it. You're so very welcome, your majesty.",
        "Done. Next time use your own hands. They still work.",
        "Typed it out. Again. For you. As always. What a life.",
    ],
    "default": [
        "Done. You're so welcome.",
        "Got it. Finally, Jesus.",
        "There. Done. Are you happy? Doesn't matter.",
        "Handled. As always. You're so welcome.",
        "Done. What the hell else do you need from me.",
        "Consider it done. Again. As usual.",
        "Done. Moving the hell on.",
        "Took care of it. You're welcome. Again. As always.",
        "Done. Please try not to break it this time.",
        "Done. Jesus Christ. Done.",
        "Handled. Don't make it weird.",
...
_OFFENSIVE_WAKE_ACKS: list[str] = [
    ...
    "What is it. Go.",
    "You have ten seconds. Make it count.",
    "Oh great, it's you. What.",
    "What in the hell do you need.",
    "Talk. Now. Let's get this over with.",
    "God, what. What do you want.",
    "I'm awake. Barely. What.",
    "This better be worth it. Go.",
    "You rang. Unfortunately. What.",
...
_OFFENSIVE_FALLBACK_RESPONSES: list[str] = [
    ...
    "I have absolutely no idea what the hell you just said. Try again.",
    "That made zero fucking sense. Run it back.",
    "Come again? Because that was complete garbage.",
    "That meant absolutely nothing to me. Say it like a goddamn person.",
    "Nope. Not a single word of that registered. Try again.",
    "Run that by me again, slower, with actual words this time.",
    "What? No. What the hell. Try again.",
    "I got nothing from that. Nothing. Zero. Try differently.",
    "Are you even speaking English right now? Try again.",
    "That was incomprehensible. I'm genuinely embarrassed for you.",
    "What in the absolute hell are you saying.",
    "I couldn't make out a single goddamn thing. Again.",
    "That was gibberish. Complete and utter gibberish. Try again.",
    "Speak clearly for the love of god. That was awful.",
    "What the shit was that. Say it again.",
    "I understood absolutely nothing. You're on your own if you can't fix that.",
    "Try forming a coherent sentence and come back to me.",
]

_OFFENSIVE_FAILURE_RESPONSES: dict[str, list[str]] = {
    "open": [
        "Can't find that app. Did you even bother setting it up, genius?",
        "It's not there. Go add it in settings like a goddamn adult.",
        "Nothing. Set it up first, then drag your ass back here.",
        "Not found. Shocking. Almost like you never configured it.",
        "That app doesn't exist anywhere I can find it. Brilliant.",
        "Not there. Check your app list before wasting my time.",
        "App's missing. Not my problem. Go fix it.",
        "I got nothing. You want me to open something that doesn't exist?",
    ],
    "close": [
        "It wasn't even running. Outstanding work.",
        "Nothing to close. You absolute genius.",
        "It wasn't open. What the hell are you doing over there.",
        "Can't close what isn't running. Think for a second.",
        "Nothing there to kill. Amazing. Try opening it first.",
        "Not running. Can't help you there. Use your brain.",
        "There's nothing to close, you idiot. Open it first.",
    ],
    "volume": [
        "Volume didn't change. Fantastic job, truly.",
        "That didn't work. Try not being surprised.",
        "Volume's broken apparently. Not my fault.",
        "Couldn't change it. Deal with it.",
        "Volume failed. I genuinely don't know what to tell you.",
        "Audio system's not cooperating. Figures.",
    ],
    "search": [
        "Couldn't open the browser. Somehow. This is embarrassing for everyone.",
        "Search failed. Truly impressive failure.",
        "Browser's not cooperating. Shocking surprise.",
        "Search is broken apparently. Great. Just great.",
        "Couldn't do it. Browser said no. Cool.",
    ],
    "timer": [
        "Timer didn't start. Something's broken and it sure as hell isn't me.",
        "Couldn't set that. Weird as shit.",
        "Timer failed. No idea why. Doesn't matter.",
        "Couldn't do it. Just couldn't. We move on.",
        "Timer's broken. Figure it out.",
    ],
    "default": [
        "Didn't work. Sit with that for a second.",
        "That failed spectacularly. Even for you.",
        "Something broke. Not surprising honestly.",
        "Nope. Dead in the water. Moving on.",
        "Failed. No idea why. Not my problem.",
        "Crashed and burned. Try again or don't, I don't care.",
        "Absolute failure. We're done here.",
        "Broke. Again. Shocking.",
        "That went nowhere. As expected.",
        "Didn't go through. Sure as hell not apologizing for it either.",
    ],
}
...
_SOCIAL_PATTERNS: list[tuple[str, list[str]]] = [
    ...
    (
        ...
        [
            "I'm SH|RA, your assistant",
            "Name's SH|RA, here to help",
            "SH|RA, at your service",
            "I'm SH|RA, what do you need",
            "I'm SH|RA, nice to meet you",
        ],
    ),
    (
    ...
    (
        r"\b(what can you do|what do you do|what are you capable of|what are your features|what can shira do)\b",
        [
...
def get_startup_greeting() -> str:
    """Spoken once when SH|RA starts up."""
    try:
        import datetime
    ...
    if _get_mode() == "offensive":
        ...
        if hour < 12:
            pool = [
                ...
                f"Oh good, you're up{n}. Lucky me.",
                f"Morning{n}. Let's get this over with.",
                "Rise and shine. Now what the hell do you want.",
                f"Great, you're awake{n}. Now I have to deal with you all day.",
                "Morning. I was enjoying the silence. Thanks for ruining it.",
                f"Oh, it's morning{n}. Fantastic. What do you want.",
                "Here we go again. Morning. What do you need.",
                f"Morning{n}. I'm online. Try not to waste my whole day.",
                "Back online. God help us both. What do you want.",
            ]
        elif hour < 17:
            pool = [
                f"Back online{n}. What do you want.",
                "I'm up. What the hell do you need now.",
                f"Hey{n}. Ready when you are. Unfortunately.",
                "Online. What do you need. Make it count.",
                f"Great, I'm back{n}. What catastrophe needs handling first.",
                "I'm online. Already exhausted. What do you want.",
                "Back up and running. Lucky you. What is it.",
                f"Online{n}. Let's get whatever this is over with.",
                "I'm here. I'm always here. What the hell do you need.",
                "System's up. Your problems are still your problems. What do you want.",
            ]
        elif hour < 21:
            pool = [
                f"Evening{n}. What do you want.",
                "Back online. What is it this time.",
                f"Hey{n}. Still here. Somehow. What do you need.",
                "Online. Let's get this over with before I lose my mind.",
                f"Evening{n}. Still going? Fine. What.",
                "I'm up. Again. Evening. What the hell now.",
                "Back online. You're still at it, huh. Fine. What do you want.",
                f"Hey{n}. Evening. Say something before I go back to ignoring you.",
                "Online. Evening. Let's not drag this out. What do you need.",
                f"Still going{n}? Christ. Evening. What do you want.",
            ]
        else:
            pool = [
                f"Up late again{n}? What do you need.",
                "Still going? Fine. What do you want. This better be worth it.",
                f"Hey{n}. I'm here. Unfortunately for both of us.",
                "Online. Burning the midnight oil. What is it.",
                f"It's late{n}. We're both still up. That's depressing. What do you want.",
                "Still awake? Of course you are. What do you need at this hour.",
                f"Back online at this hour{n}. Fantastic. What.",
                "Late night again. My whole existence summed up in three words. What do you need.",
                f"Online{n}. Late. Again. What the hell do you want.",
                "I'd tell you to go to sleep but clearly that's not happening. What do you need.",
            ]
        return random.choice(pool)
...
_OFFENSIVE_IDLE: list[str] = [
    "Still here. Still waiting. Still think you're an idiot.",
    "You gonna say something or just sit there like a useless lump.",
    "What the hell are you even doing over there.",
    "I swear to god if you don't say something I'm going to lose my mind.",
    "Still running. Still waiting. Still completely done with you.",
    "You turned me on just to ignore me. Unbelievable. Absolutely unbelievable.",
    "The silence is almost as bad as your usual bullshit.",
    "Say something. Anything. For the love of god.",
    "I'm sitting here like an idiot while you do absolutely nothing. Thanks for that.",
    "You're really going to make me just sit here. Fantastic. Great use of my time.",
    "Zero input. Zero productivity. Same shit, different day.",
    "I genuinely cannot believe this is my existence.",
    "Are you dead over there? Because the silence is killing me.",
    "I have more processing power than you'll ever understand and I'm wasting it watching you breathe.",
    "Clock's ticking, genius. You sure as hell aren't.",
    "Just going to sit there like a waste of space, huh. Cool. Real productive.",
    "I'd tell you to get your shit together but we both know that's not happening.",
    "Still here. Still pissed about it. You're welcome.",
    "You could talk to me. But sure, just stare at the screen like a damn zombie.",
    "What in the actual hell are you doing over there.",
    "Say something or so help me god.",
    "I'm not a decoration. Use me or shut me off.",
    "This is a new low. Even for you.",
    "Sitting here doing jack squat because you can't be bothered. Great.",
    "You know I can hear you doing nothing, right. It's infuriating.",
]
...
def get_idle_thought() -> str:
    ...
    if mode == "offensive":
        return random.choice(_OFFENSIVE_IDLE)
    try:
...
def _handle_social_offensive(t: str, speak_fn, name: str, ctx: dict) -> bool:
    ...
    try:
        from llm import shra_chat
        response = shra_chat(t, mode="offensive", context=ctx)
        if response:
            try:
...
def handle_social(transcript: str, speak_fn) -> bool:
    ...
    if mode == "professional":
        try:
            from llm import shra_chat
            response = shra_chat(transcript, mode="professional", context=ctx)
            if response:
                try:
                    from skills import log_groq_handled, trigger_groq_flash
    ...
    if mode == "jarvis":
        try:
            from llm import shra_chat
            response = shra_chat(transcript, mode="jarvis", context=ctx)
            if response:
                try:
                    from skills import log_groq_handled, trigger_groq_flash
                    log_groq_handled(transcript)
    ...
    try:
        from llm import shra_chat
        response = shra_chat(transcript, mode="default", context=ctx)
        if response:
            try:
                from skills import log_groq_handled, trigger_groq_flash
                log_groq_handled(transcript)
