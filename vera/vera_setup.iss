...
[Files]
; Obfuscated Python source — generated by obfuscate.py into installer_stage/
Source: "installer_stage\*.py";                            DestDir: "{app}";                        Flags: ignoreversion
Source: "installer_stage\pyarmor_runtime_012159\*";        DestDir: "{app}\pyarmor_runtime_012159";  Flags: ignoreversion recursesubdirs
...
; Fuzzy intent phrase index (generated by gen_intent_phrases.py)
Source: "data\intent_phrases.json"; DestDir: "{app}\data"; Flags: ignoreversion
...
[InstallDelete]
; Clean up dev-only files that shipped accidentally in pre-0.98.1 installers
Type: files; Name: "{app}\smoke_test.py"
Type: files; Name: "{app}\sync_public.py"
Type: files; Name: "{app}\discord_post.py"
Type: files; Name: "{app}\gen_intent_phrases.py"
Type: files; Name: "{app}\joystick_probe.py"
Type: files; Name: "{app}\mouse_probe.py"
