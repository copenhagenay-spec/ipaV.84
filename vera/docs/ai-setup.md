...
This guide explains how to set up the **"ask \<question\>"** voice command in VERA.

---

## How It Works

When you say **"ask \<question\>"**, VERA sends your question to an AI provider and reads the answer aloud via text-to-speech. You need an API key from one of the supported providers to use this feature.

---

## Supported Providers

VERA automatically detects which provider to use based on your API key — no extra configuration needed.
...
- VERA keeps AI answers short — 2 to 3 sentences maximum
...
- You only need one API key — VERA will detect the provider automatically

---

## Troubleshooting

**"VERA said it couldn't reach the AI"**
